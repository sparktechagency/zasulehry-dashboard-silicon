...
export default function CreateAdmin({ trigger }: { trigger: React.ReactNode }) {
    ...
    <Dialog>
      <div>
        <form>
          ...
          <DialogContent className="sm:max-w-[550px] xl:max-w-[850px] overflow-y-scroll h-[80%]">
            <h1 className="text-xl font-medium">Create Sub Admin</h1>
            <div className="grid grid-cols-2 gap-4 mt-5">
              <div>
                <label className="text-[#333333] font-medium mb-">
                  User Name
                </label>
                <Input
                  name="userName"
            ...
            <button
              className="btn-design py-3 w-80 mt-6 lg:text-xl"
              type="submit"
            >
              Confirm
            </button>
